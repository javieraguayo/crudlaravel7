...
<div >
<h2>Laravel 7 CRUD Bootstrap</h2>
</div>
<br/>
</div>
</div>
...
<a href="javascript:void(0)" class="btn btn-success mb-2" id="new-customer" data-toggle="modal">Nuevo vendedor</a>
</div>
</div>
</div>
<br/>
...
<a class="btn btn-info" id="show-customer" data-toggle="modal" data-id="{{ $customer->id }}" >Ver</a>
<a href="javascript:void(0)" class="btn btn-success" id="edit-customer" data-toggle="modal" data-id="{{ $customer->id }}">Editar</a>
<meta name="csrf-token" content="{{ csrf_token() }}">
<a id="delete-customer" data-id="{{ $customer->id }}" class="btn btn-danger delete-user">Eliminar</a></td>
</form>
</td>
</tr>
@endforeach
...
<input type="text" name="name" id="name" class="form-control" placeholder="Nombre" onchange="validate()" >
</div>
</div>
<div class="col-xs-12 col-sm-12 col-md-12">
<div class="form-group">
...
<input type="text" name="address" id="address" class="form-control" placeholder="Dirección" onchange="validate()" onkeypress="validate()">
</div>
</div>
...
<tr><td colspan="2" style="text-align: right "><a href="{{ route('customers.index') }}" class="btn btn-danger">Cerrar</a> </td></tr>
</table>
@endif
</div>
</div>
